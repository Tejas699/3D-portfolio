...
const ServiceCard = ({ index, title, icon, info }) => (
  <Tilt className='xs:w-[325px] w-full'>
    <motion.div
      ...
      >
        <div style={{ width: "100%" }} >
          <img
            src={icon}
            alt='web-development'
            className='w-16 h-16 object-contain rotate linear infinite'
            // class="rotate linear infinite"
          />
        </div>

        <h3 style={{ width: '100%', }} className='text-white text-[20px] font-bold text-left'> {title} </h3>
        <h6> {info} </h6>
      </div>
    </motion.div>
  </Tilt>
